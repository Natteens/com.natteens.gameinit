...
namespace GameInit.PooledObjects
{
    public class PoolableObject : MonoBehaviour
    {
        ...
        public System.Action OnSpawnFromPool;
        ...
        /// <summary>
        /// Inicia um timer para auto-despawn
        /// </summary>
        ...
        IEnumerator TimerCoroutine()
        {
            ...
            {
                if (!hasActiveTimer || IsInPool || !IsActive || gameObject == null || !gameObject.activeInHierarchy)
                    yield break;
            ...
            if (hasActiveTimer && IsActive && !IsInPool && gameObject != null && gameObject.activeInHierarchy)
            {
                hasActiveTimer = false;
        ...
        /// <summary>
        /// Detecta objetos órfãos sem timer
        /// </summary>
        void Update()
        {
